...
### Internal Discovery and Platform Selection
  ...
  As a member of the panel selecting a new software platform, I was able to use the documentation and user flows my team created to make an informed decision to replatform the e-commerce site to [Sitecore](https://www.sitecore.com/). The moved allowed us to maintain our technical stack, integrate with the internal legacy systems, and create a foundation for future upgrades.
