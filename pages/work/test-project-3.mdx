...
<Head>
  <title>Sample Number 2 - Christy Presler</title>
  <meta name='description' content='This is an example of a project with sample data for dev purposes' />
</Head>
...
<ResponsiveImage src={'images/projects/sample-number-2/work-photo1.jpg'} width={240} height={240} alt='sample layout image' />
